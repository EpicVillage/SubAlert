      ...
      <div className="lock-container">
        {biometricEnabled && biometricAvailable && isMobile ? (
          <>
            <button 
              type="button" 
              className="lock-icon fingerprint-icon" 
              onClick={handleBiometricAuth}
              disabled={isAuthenticating}
            >
              <svg width="80" height="80" viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
